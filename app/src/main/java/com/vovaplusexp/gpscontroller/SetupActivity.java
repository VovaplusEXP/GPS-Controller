...
public class SetupActivity extends AppCompatActivity {
    ...
    private void downloadMap() {
        ...
        mapDownloadManager.setDownloadListener(new MapDownloadManager.DownloadListener() {
            @Override
            public void onProgress(int percent) {
                progressBar.setProgress(percent);
                statusText.setText(getString(R.string.downloading) + " " + percent + "%");
            }
            
            @Override
            public void onComplete(java.io.File file) {
                prefsManager.setMapDownloaded(true);
                statusText.setText("Map downloaded successfully");
